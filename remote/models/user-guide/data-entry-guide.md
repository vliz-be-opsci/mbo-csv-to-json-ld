...
![](images/MARCO_BOLO_CSV_Process_V3.png)
...
### Table Types:
- **Mandatory Tables** (yellow): Must be completed for all datasets
- **Conditional Tables** (blue): Must be completed where this information exists/applies for the dataset
- **Optional Tables** (green): Useful but not essential information for the dataset
