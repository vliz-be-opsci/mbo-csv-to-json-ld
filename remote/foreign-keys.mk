...
out/validation/Action-csv-list-column-foreign-key.success.log: data/Action.csv data/Dataset.csv data/HowTo.csv out/validation/person-or-organization.csv out/validation
...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/Audience.csv data/License.csv data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/Taxon.csv data/DataDownload.csv data/EmbargoStatement.csv data/Audience.csv data/License.csv data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv data/PropertyValue.csv data/Place.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/Taxon.csv data/Audience.csv data/EmbargoStatement.csv data/License.csv data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv data/Place.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Service.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/Audience.csv data/HowToTip.csv data/SoftwareApplication.csv data/Service.csv out/validation/person-or-organization.csv data/HowToStep.csv data/SoftwareSourceCode.csv out/validation
