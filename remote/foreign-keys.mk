...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/Audience.csv data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv data/License.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/PublishingStatusDefinedTerm.csv data/PropertyValue.csv out/validation/person-or-organization.csv data/DataDownload.csv data/Taxon.csv data/Audience.csv data/Place.csv data/License.csv data/EmbargoStatement.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv data/Taxon.csv data/Audience.csv data/Place.csv data/License.csv data/EmbargoStatement.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Service.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/Service.csv out/validation/person-or-organization.csv data/SoftwareSourceCode.csv data/HowToTip.csv data/Audience.csv data/HowToStep.csv data/SoftwareApplication.csv out/validation
