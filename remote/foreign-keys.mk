...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/PublishingStatusDefinedTerm.csv data/License.csv data/Audience.csv out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/License.csv data/Place.csv data/DataDownload.csv data/PropertyValue.csv data/EmbargoStatement.csv data/Audience.csv out/validation/person-or-organization.csv data/Taxon.csv data/PublishingStatusDefinedTerm.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/License.csv data/Place.csv data/EmbargoStatement.csv data/Audience.csv out/validation/person-or-organization.csv data/Taxon.csv data/PublishingStatusDefinedTerm.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Service.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/Service.csv data/HowToTip.csv data/SoftwareSourceCode.csv data/Audience.csv out/validation/person-or-organization.csv data/SoftwareApplication.csv data/HowToStep.csv out/validation
