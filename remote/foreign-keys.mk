...
out/validation/Action-csv-list-column-foreign-key.success.log: data/HowTo.csv data/Action.csv out/validation/person-or-organization.csv data/Dataset.csv out/validation
...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/PublishingStatusDefinedTerm.csv data/License.csv out/validation/person-or-organization.csv data/Audience.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/License.csv data/EmbargoStatement.csv data/DataDownload.csv data/Taxon.csv data/PublishingStatusDefinedTerm.csv data/PropertyValue.csv data/Place.csv data/Audience.csv out/validation/person-or-organization.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/License.csv data/EmbargoStatement.csv data/Taxon.csv data/PublishingStatusDefinedTerm.csv data/Place.csv data/Audience.csv out/validation/person-or-organization.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Service.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/HowToTip.csv data/Service.csv data/SoftwareApplication.csv data/HowToStep.csv data/SoftwareSourceCode.csv data/Audience.csv out/validation/person-or-organization.csv out/validation
