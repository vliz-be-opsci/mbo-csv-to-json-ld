...
out/validation/Action-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv HowTo.csv Dataset.csv Action.csv out/validation
	...
	@echo ""
out/validation/DataDownload-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv PublishingStatusDefinedTerm.csv Audience.csv License.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: License.csv EmbargoStatement.csv PublishingStatusDefinedTerm.csv PropertyValue.csv Audience.csv out/validation/person-or-organization.csv DataDownload.csv Taxon.csv Place.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: SoftwareSourceCode.csv HowToTip.csv out/validation/person-or-organization.csv SoftwareApplication.csv HowToStep.csv Service.csv Audience.csv out/validation
...
out/validation/Organization-csv-list-column-foreign-key.success.log: ContactPoint.csv MonetaryGrant.csv Organization.csv out/validation
	...
	@echo ""
out/validation/Person-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv ContactPoint.csv Organization.csv out/validation
	...
	@echo "=============================== Validating values in Person.csv['Ocean Expert ID'] ==============================="
	@RES=$$($(LIST_COLUMN_FOREIGN_KEY_CHECK) "Person.csv" "Ocean Expert ID" "out/validation/person-or-organization.csv" "MBO Permanent Identifier*") && echo "$$RES" || echo "$$RES" >> "out/validation/Person-csv-list-column-foreign-key.err.log"
