...
out/validation/Action-csv-list-column-foreign-key.success.log: data/HowTo.csv out/validation/person-or-organization.csv data/Dataset.csv data/Action.csv out/validation
	...
	@echo ""
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/License.csv data/Audience.csv out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv data/DataDownload.csv data/Audience.csv data/PublishingStatusDefinedTerm.csv data/License.csv data/PropertyValue.csv data/Place.csv data/Taxon.csv out/validation/person-or-organization.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv data/Audience.csv data/PublishingStatusDefinedTerm.csv data/License.csv data/Place.csv data/Taxon.csv out/validation/person-or-organization.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Service.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/SoftwareSourceCode.csv data/Audience.csv data/HowToTip.csv data/SoftwareApplication.csv data/Service.csv out/validation/person-or-organization.csv data/HowToStep.csv out/validation
